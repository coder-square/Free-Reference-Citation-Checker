...
from citation_styles import detect_citation_style, format_reference
...
class ReferenceCheckResult:
    ...
    verified_doi: str = ""
    detected_style: str = ""  # "apa" | "mla" | "chicago" | "harvard" | "vancouver"
...
def _compare_fields_and_build_correction(raw_text: str, record, style: str) -> tuple:
...
def check_reference(raw_text: str, mailto: str) -> ReferenceCheckResult:
    ...
    field_issues, corrected = _compare_fields_and_build_correction(text, record, style)
